...
태그: `[WP4-n]` wp4 §10 프롬프트 규칙 n, `[WP4-운n]` 설계·운영 지침, `[WP13-n]` wp13 §5, `[WP1-n]` wp1 §7, `[WP11-n]` wp11 §6, `[서울-n]` 서울 §6, `[WP8-n]` wp8 §6, `[WP7]` wp7 §8·§9, `[WP5-과목-n]` README 관찰, `[2025-n]` README-사과 관찰, `[대표]` 대표님 확정, `[대표-연수2기]` 대표 교사 연수 2기 실습-2(2026-09-02 — 핵심질문 6단계·자료 설계, docs/research/2026-09-26-owner-training-deck-2.md), `[v1]` 기존 rules.ts. 성격: **P** 프롬프트 문장, **S** 스키마·검토 코드, **O** 운영 절차.
