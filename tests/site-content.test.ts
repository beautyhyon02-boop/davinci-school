...
describe('site content', () => {
  ...
  it('exposes studio copy (themes list, new theme form, theme detail intro/materials/sets/picker)', () => {
    ...
    expect(app.studio.theme.addSubjects.remove.button).toBe('빼기')
    expect(app.studio.theme.addSubjects.remove.removing).toBeTruthy()
    expect(app.studio.theme.addSubjects.remove.removed).toBeTruthy()
    expect(app.studio.theme.addSubjects.remove.hasSet).toBeTruthy()
    expect(app.studio.theme.addSubjects.remove.lastSubject).toBeTruthy()
    expect(app.studio.theme.addSubjects.remove.help).toBeTruthy()
    ...
    expect(app.studio.intro.exhausted).toBeTruthy()
    expect(app.studio.intro.edit.heading).toBe('직접 수정')
    expect(app.studio.intro.edit.help).toContain('검토를 통과하지 못해도 여기서 고친 내용을 확정할 수 있습니다')
    expect(app.studio.intro.edit.submit).toBe('수정하여 확정')
    expect(app.studio.intro.edit.submitting).toBeTruthy()
    expect(app.studio.intro.edit.saved).toBeTruthy()
    expect(app.studio.intro.edit.invalid).toBeTruthy()
    expect(app.studio.intro.edit.ideaLabel('과학')).toContain('과학')
