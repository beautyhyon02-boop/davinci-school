...
describe('site content', () => {
  ...
  it('exposes studio copy (themes list, new theme form, theme detail intro/materials/sets/picker)', () => {
    ...
    expect(app.studio.intro.help).toContain('AI 초안')
    expect(app.studio.intro.mockBadge).toBeTruthy()
    expect(app.studio.intro.busy).toBeTruthy()
    expect(app.studio.intro.introLabel).toBeTruthy()
    expect(app.studio.intro.ideaLabel('과학')).toContain('과학')
    expect(app.studio.intro.draftButton).toBeTruthy()
    expect(app.studio.intro.save).toBeTruthy()
    expect(app.studio.intro.saved).toBeTruthy()
    expect(app.studio.intro.errors.generic).toBeTruthy()
    expect(app.studio.intro.errors.introTooShort).toBeTruthy()
    expect(app.studio.intro.errors.ideaTooShort).toBeTruthy()
