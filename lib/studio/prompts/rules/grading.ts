...
export const GRADING_RULES_V2 = [
  ...
  // 경기 논술형 평가 장학자료(2025.7, WP9 §7 G-10) — 오류 이월 인정, 대표님 결정 불필요(2026-09-25)
  rule('G-10', 'P', '앞 소문항에서 학생이 잘못 구한 값을 뒤 소문항에서 그대로 이어 써서 옳게 전개했으면, 그 오류는 처음 발생한 요소에서만 감점하고 뒤 요소는 이어 쓴 값을 기준으로 정답 여부를 판단한다(오류 이월 인정).', '경기2025'),
]
