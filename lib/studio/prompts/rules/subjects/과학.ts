...
export const SCIENCE_RULES = [
  ...
  rule('S-과-03', 'P', '필수 용어(예: 항체·전기음성도)는 서술형·논술형 모두 문두(전제문·발문)에 밝히고 조건에는 쓰지 않으며(C-32), 용어를 바르게 썼는지를 채점표 요소로 배점한다.', 'WP5-과-3'),
  ...
  // 경기 논술형 평가 장학자료(2025.7, WP9 §7 S-과-08) — 대표님 결정 불필요(2026-09-25)
  rule('S-과-08', 'P', "과학 '타당성 평가' 소문항(광고 문구·주장 검증)은 과학적 근거 없이 가치 판단만 한 의견을 정답으로 인정하지 않는다는 문구를 채점 시 유의점(rubric.notes)에 넣는다(C-27의 정의적 요소 채점과는 다르다 — 여기는 사실 판단 과제).", '경기2025'),
]
