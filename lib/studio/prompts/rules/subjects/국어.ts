...
export const KOREAN_RULES = [
  rule('S-국-01', 'P', '자료는 (가)(나) 복수 통합형을 기본으로 하되 중학교는 각 200~400자, 총 2편 이내.', 'WP5-국-1', 'C-19'),
  rule('S-국-02', 'P', '논술형 조건 2~4개(C-32)를 내용 조건/형식 조건으로 나누고 채점표도 그 구분을 따른다.', 'WP5-국-2'),
  ...
  // v2: 비교 기준을 프롬프트 입력으로 받는 장치가 없으므로 모델이 문두 전제문에 명시한다(부록 A.3도 같은 문장으로 동기화).
