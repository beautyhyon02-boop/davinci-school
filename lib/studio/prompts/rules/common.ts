...
/** 부록 A.1 공통(C-) — 문항·자료·채점표. C-31은 대표님 확정값(세트 배점·등급표). */
export const COMMON_RULES = [
  rule('C-01', 'PS', '문항은 발문·자료·조건 세 요소로 구성하고, 조건에 담은 제약은 반드시 채점표 요소에 대응시킨다(condition_nos).', 'WP4-1', 'WP13-5', 'WP5-국-2', 'WP5-사-2'),
