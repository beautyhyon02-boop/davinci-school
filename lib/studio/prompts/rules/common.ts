...
export const COMMON_RULES = [
  ...
  rule('C-14', 'PS', '예시답안은 서술형은 0점을 뺀 총점 단계마다 1개(6점이면 6·5·4·3·2·1), 논술형은 상/중/하 각 1개를 요소별 점수·채점자 의견(rationale)과 함께 만들고, "유일한 정답이 아님"을 유의점에 적는다.', '서울-5', 'WP4-17', 'WP13-7', 'WP5-영-5'),
  ...
  rule('C-31', 'PS', '세트 평가는 서술형 1문항(6점, 채점 요소 2~3개) + 논술형 1문항(16점, 4요소 × 0~4점) = 22점이고, 두 문항 모두 분석적 + 총체적 채점표를 갖춘다(대표 2026-09-26, 배점은 본사 가정). 등급표는 7등급(21~22, 18~20, 15~17, 11~14, 8~10, 5~7, 0~4; 상=6~7, 중=3~5, 하=1~2)에 level_ref(7=A, 6=B, 5=C, 4=D, 3=E, 2·1=E 미만)를 병기한다. 논술형 예시답안 상/중/하는 채점표로 실제 채점한 점수에 전제한 서술형 점수(assumed_short_points, 0~6)를 더했을 때 그 밴드가 나와야 한다.', '대표', 'v1'),
